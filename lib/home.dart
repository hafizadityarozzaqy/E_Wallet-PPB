...
class _HomePageState extends State<HomePage> {
  Color mainColor = Color.fromARGB(255, 238, 238, 238);
                    ...
                    children: <Widget> [
                      Container(
                          ...
                          children: <Widget>[
                            Container(
                              decoration: BoxDecoration(
                                color: Color.fromRGBO(255, 13, 71, 161),
                        ...
                        padding: EdgeInsets.all(8),
                            ...
                            Text("Send", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: Colors.blue),)
                          ],
                        ),
                      ),
                      ...
                      Container(
                        ...
                        padding: EdgeInsets.all(8),
                            ...
                            Text("Top up", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: Colors.blue),)
                          ],
                        ),
                      ),
                      ...
                      Container(
                        ...
                        padding: EdgeInsets.all(8),
                            ...
                            Text("Pay", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: Colors.blue),)
                          ],
                        ),
                      ),
                      ...
                      Container(
                        ...
                        padding: EdgeInsets.all(8),
                            ...
                            Text("History", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: Colors.blue),)
                          ],
                        ),
                      ),
